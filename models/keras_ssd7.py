...
import numpy as np
import tensorflow ## added this to directly use tensorflow.keras.Model
from tensorflow.keras.models import Model  ## this is never used. tensorflow.keras.Model directly used when intantiating
...
def build_model(image_size,
    ...
    if mode == 'training':
        model = tensorflow.keras.Model(inputs=x, outputs=predictions)
    elif mode == 'inference':
        ...
        model = tensorflow.keras.Model(inputs=x, outputs=decoded_predictions)
