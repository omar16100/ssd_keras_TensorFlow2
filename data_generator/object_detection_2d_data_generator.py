...
class DataGenerator:
    ...
    def generate(self,
        ...
        while True:
            ...
            ret = []
            if 'processed_images' in returns: ret.append(batch_X)  ## this used in the main training file
            if 'encoded_labels' in returns: ret.append(batch_y_encoded)  ## this used in the main training file
            ...
            yield tuple(ret)  ## this cannot be list. Has to be a tuple, else error: got 2 instead of 1: Major error
