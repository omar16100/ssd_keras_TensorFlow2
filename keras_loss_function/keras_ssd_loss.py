...
class SSDLoss:
    ...
    def compute_loss(self, y_true, y_pred):
        ...
        '''
        #print(type(self.neg_pos_ratio))  ## a tensor
        #self.neg_pos_ratio = tf.constant(self.neg_pos_ratio)
        #self.neg_pos_ratio = self.neg_pos_ratio ##### me: has earlier for ssd7, now removed for ssd300
        #self.n_neg_min = tf.constant(self.n_neg_min)
        #self.n_neg_min = self.n_neg_min ##### me: has earlier for ssd7, now removed for ssd300
        #self.alpha = tf.constant(self.alpha)
        #self.alpha = self.alpha ##### me: has earlier for ssd7, now removed for ssd300
        ...
        ######Changed tf.to_float call to tf.cast(..., dtype=tf.float32)
