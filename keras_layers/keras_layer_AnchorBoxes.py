...
import numpy as np
import tensorflow.keras.backend as K   ## changed for tf2
from tensorflow.keras.layers import InputSpec  ## changed for tf2
from tensorflow.keras.layers  import Layer  ## changed for tf2
...
class AnchorBoxes(Layer):
    ...
    def call(self, x, mask=None):
        ...
        if K.image_data_format() == 'channels_last':  ###https://github.com/keras-team/keras/issues/12649
            #print(x.shape)
            #print(type(x.shape))
            #batch_size, feature_map_height, feature_map_width, feature_map_channels = x._keras_shape
            batch_size, feature_map_height, feature_map_width, feature_map_channels = x.shape
            #print(batch_size, feature_map_height, feature_map_width, feature_map_channels)
            #print("I was here")
